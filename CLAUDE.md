...
> Full architecture diagram and details: see [SPEC.md](SPEC.md) Section 3.
...
> Full project structure: see [SPEC.md](SPEC.md) Section 4.

## Design System Token Reference

> **Complete token tables with hex values are in [SPEC.md](SPEC.md) Section 5.**
...
- Design system build guide: `DESIGN_SYSTEM_PLAYBOOK.md`
